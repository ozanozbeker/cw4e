...
- Initialize Git repositories and track changes to your projects (@sec-git)
- Run Quarto to transform Markdown files into beautiful documents and websites (@sec-quarto)
- Use `uv` to create Python virtual environments and manage dependencies (@sec-python-projects)
- Execute Python scripts and SQL queries from the command line (@sec-python-fundamentals, @sec-querying)
- Build automated pipelines that orchestrate multiple tools (@sec-typer)
