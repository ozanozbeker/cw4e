...
**Programming** teaches programming as a tool for orchestrating workflows. Rather than treating Python as a general-purpose language, we focus on the patterns most useful for data work: reading files, calling APIs, transforming data, and generating outputs.

**Integration** brings SQL and Python together, showing how to build complete data pipelines that extract, transform, and load data reliably.

**Delivery** covers the skills that turn projects into products: documentation, testing, packaging, and deployment.
