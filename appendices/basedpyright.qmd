...
## Why basedpyright for This Course?
...
For completeness: `uv tool install basedpyright` installs it into its own isolated environment outside any project. As with Ruff, this course keeps everything inside the project's virtual environment for reproducibility.
