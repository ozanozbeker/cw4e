...
When you start combining SQL with Python in @sec-python-sql, you'll add DuckDB as a project dependency:
...
DuckDB is introduced in @sec-databases and used throughout the database module. You'll also connect to DuckDB from Python in @sec-python-sql and use it inside Marimo notebooks in @sec-marimo-config. The SQL you write against DuckDB is standard ANSI SQL that transfers to any other database engine.
